...
// 7 animation 7 Led  pins A0 to A6
...
int main(void) {
	...
	*pModeRegB |= 0x8;                           // Set GPIOB pin 0 to input mode with pull-down
	...
	for (;;) {                                   // Loop forever
		...
		switch (choice) {
		case 1:
			LedAnime1(3, 10);                    // Execute animation 1
			break;
		case 2:
			LedAnime2(3, 10);                    // Execute animation 2
			break;
		case 3:
			LedAnime3(3, 10);                    // Execute animation 3
			break;
		case 4:
			LedAnime4(3, 10);                    // Execute animation 4
			break;
		case 5:
			LedAnime5(3, 10);                    // Execute animation 5
			break;
		case 6:
			LedAnime6(3, 25);                    // Execute animation 6
			break;
		case 7:
			LedAnime7(3, 25);                    // Execute animation 7
			break;
		default:
